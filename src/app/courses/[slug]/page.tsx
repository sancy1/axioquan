...
// import { Button } from '@/components/ui/button';
// import { Card, CardContent, CardDescription, CardHeader, CardTitle } from '@/components/ui/card';
// import { Star, Clock, Users, BookOpen, ChevronDown, Play, Check, Award, Globe, Calendar, Heart, Share2, Eye } from 'lucide-react';
// import { useState, useEffect } from 'react';
// import { Header } from '@/components/layout/header';
// import { Footer } from '@/components/layout/footer';
...
//                   <div className="flex items-center gap-2">
//                     <Eye size={18} />
//                     <span className="font-semibold">{course.total_views || 0} views</span>
//                   </div>
//                 </div>
...
//               {/* Enrollment Card - Existing code remains the same */}
//               <div className="bg-gray-800 text-white rounded-2xl p-8 shadow-2xl h-fit border border-gray-700">
//                 {/* Course Thumbnail with Play Button */}
//                 <div className="w-full h-48 rounded-lg overflow-hidden mb-6 bg-gray-700 relative">
//                   {course.thumbnail_url ? (
...
//         {/* Instructor Section - Existing code remains the same */}
//         <section className="bg-gray-50 border-b border-gray-200">
//           <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
//             <h2 className="text-2xl font-bold mb-8 text-gray-900">About the Instructor</h2>
//             <div className="flex gap-8 items-start">
...
// // /src/app/courses/[slug]/page.tsx (UPDATED - With view tracking)
...
//         setCourse(result.course);
//         setViewCount(result.course.total_views || 0);
        
//         // Record the view after course data is loaded
//         await recordCourseView(result.course.id);
//       } catch (err) {
//         setError('Failed to load course');
//         console.error('Error fetching course:', err);
//       } finally {
...
//   // Client component for interactive parts
//   function CourseClientContent({ course, viewCount }: { course: any; viewCount: number }) {
//     const [isEnrolled, setIsEnrolled] = useState(false);
...
//   return <CourseClientContent course={course} viewCount={viewCount} />;
// }
...
//         // Record the view after course data is loaded
//         await recordCourseView(courseResult.course.id);
//       } catch (err) {
//         setError('Failed to load course');
//         console.error('Error fetching course:', err);
//       } finally {
...
//   // Client component for interactive parts
//   function CourseClientContent({ course, curriculum, viewCount }: { course: any; curriculum: any[]; viewCount: number }) {
//     const [isEnrolled, setIsEnrolled] = useState(false);
...
//               {/* Course Curriculum - REPLACED with actual curriculum component */}
//               <div className="mb-12">
//                 <CourseCurriculum 
...
//   return <CourseClientContent course={course} curriculum={curriculum} viewCount={viewCount} />;
// }
...
//               {/* Enrollment Card - Updated with enrollment component */}
// <div className="bg-gray-800 text-white rounded-2xl p-8 shadow-2xl h-fit border border-gray-700">
//   {/* Course Thumbnail with Play Button */}
//   <div className="w-full h-48 rounded-lg overflow-hidden mb-6 bg-gray-700 relative">
//     {course.thumbnail_url ? (
...
//   {/* Replace the old button with the enrollment component */}
//   <CourseEnrollment 
//     courseId={course.id}
//     courseSlug={course.slug}
...
//   <div className="bg-white rounded-2xl p-6 border-2 border-gray-200 shadow-lg sticky top-20">
//     <div className="mb-6 space-y-4">
//       {/* FIXED: Use curriculum length instead of course.total_lessons */}
//       <div className="flex items-center gap-2">
//         <BookOpen className="text-gray-700" size={20} />
//         <span className="font-semibold text-gray-900">
//           {curriculum.reduce((total: number, module: any) => total + (module.lessons?.length || 0), 0)} lessons
//         </span>
//       </div>
      
//       {/* Also fix the duration - use actual curriculum duration */}
//       <div className="flex items-center gap-2">
//         <Clock className="text-gray-700" size={20} />
//         <span className="font-semibold text-gray-900">
//           {formatDuration(
//             curriculum.reduce((total: number, module: any) => {
//               const moduleDuration = module.lessons?.reduce((moduleTotal: number, lesson: any) => {
...
//     {/* CourseEnrollment component - make sure it shows correct enrollment status */}
//     <CourseEnrollment 
//       courseId={course.id}
//       courseSlug={course.slug}
//       priceCents={course.price_cents}
...
<div>
  <div className="bg-white rounded-2xl p-6 border-2 border-gray-200 shadow-lg sticky top-20">
    ...
    {/* CourseEnrollment component - make sure it shows correct enrollment status */}
    {/* UPDATED: Added black background class to the container */}
