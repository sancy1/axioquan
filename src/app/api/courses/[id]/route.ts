...
// import { getCoursesAction, updateCourseAction, deleteCourseAction } from '@/lib/courses/actions';
// import { getCourseById } from '@/lib/db/queries/courses'; // Add this import
...
import { NextRequest } from 'next/server';
import { updateCourseAction, deleteCourseAction } from '@/lib/courses/actions';
import { getCourseById } from '@/lib/db/queries/courses'; // Direct database query
import { requireRole } from '@/lib/auth/utils';
...
export async function GET(request: NextRequest, { params }: RouteParams) {
  try {
    ...
    // Use direct database query instead of missing action
