...
//   submittedAt: string;
//   timeSpent: number;
//   // ✅ NEW: Real attempt ID for proper linking
//   realAttemptId?: string;
//   // ✅ NEW: Flag to indicate if we have real IDs for linking
//   hasValidIds?: boolean;
// }
...
//                 submittedAt: item.date,
//                 timeSpent: 1800, // Default time spent
//                 // ❌ Analytics trend data doesn't have real IDs for linking
//                 hasValidIds: false
//               }));
...
//             submittedAt: item.submitted_at || new Date().toISOString(),
//             timeSpent: item.time_spent || 0,
//             // ✅ Store the real attempt ID (this is the actual attempt UUID)
//             realAttemptId: item.id,
//             // ✅ Mark as having valid IDs for linking
//             hasValidIds: true
//           }));
...
//             submittedAt: item.submittedAt || new Date(Date.now() - (index * 86400000)).toISOString(),
//             timeSpent: item.timeSpent || 1800,
//             // ❌ Local storage data doesn't have real IDs for linking
//             hasValidIds: false
//           }));
...
//         submittedAt: new Date(Date.now() - 2 * 24 * 60 * 60 * 1000).toISOString(),
//         timeSpent: 1800,
//         // ❌ Demo data doesn't have real IDs for linking
//         hasValidIds: false
//       },
//       {
//         id: 'demo-2',
...
//                     <div>Has Valid IDs: {results[0].hasValidIds ? '✅ Yes' : '❌ No'}</div>
...
//                       Generated Link: {generateResultLink(results[0]) || '❌ No link (expected for demo/analytics data)'}
//                     </div>
//                   </div>
//                 )}
//               </div>
...
//                             {/* =========================================================== */}
//                             {/* 🎯 THIS IS WHERE THE LINK APPEARS - OVERVIEW TAB */}
//                             {/* =========================================================== */}
//                             {link ? (
//                               <Link href={link}>
//                                 <Button 
...
//                               {/* =========================================================== */}
//                               {/* 🎯 THIS IS WHERE THE LINK APPEARS - HISTORY TAB */}
//                               {/* =========================================================== */}
//                               {link ? (
//                                 <Link href={link}>
//                                   <Button 
