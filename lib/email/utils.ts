// /lib/email/utils.ts
// REMOVE 'use server' directive since this file is only used by server actions
...
// Create email transporter - can stay sync
...
// Get email configuration from environment - can stay sync
...
// Send email function - keep async
